...
public class BankAccountController {
	...
	public ResponseEntity<BankAccount> depositMoney2BankAccount(@PathVariable(name = "id") String id,
			@RequestBody AccountDepositMoneyRequest amount) {
	...
	public ResponseEntity<AccountMoneyTransferResponse> moneyTransferFromBankAccount(
			@PathVariable(name = "id") String id, @RequestBody AccountMoneyTransferRequest transferRequest) {
